...
PATHS=(/unifier-test/fhir/v0/r4/metadata /unifier-test/fhir/v0/r4/.well-known/smart-configuration /unifier-test/fhir/v0/dstu2/metadata /unifier-test/fhir/v0/dstu2/.well-known/smart-configuration /unifier-test/fhir/v0/argonaut/data-query/metadata /unifier-test/fhir/v0/argonaut/data-query/.well-known/smart-configuration)
SUCCESS=0
FAILURE=0
